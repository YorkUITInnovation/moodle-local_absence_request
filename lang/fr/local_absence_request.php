...
$string['filter_by_absence_date'] = 'Filtrer par date d\'absence';
$string['from_date'] = 'Date de début de soumission';
$string['from_reported_date'] = 'Date de début signalée';
$string['to_date'] = 'Date de fin de soumission';
$string['to_reported_date'] = 'Date de fin signalée';
...
$string['bulk_acknowledge'] = 'Accuser réception des sélectionnés';
